...
ap.add_argument("--nepoch", type=int, default=10, help="Number of epochs for training")
...
# ap.add_argument("--phase1_nepoch", type=int, default=10, help="Number of epochs for phase 1 training") # uncomment to continue working on different phases
